...
const getComponents = (skeleton) => {
  ...
  const start_p4 = FP.getPointOnLine(out_heng_start, out_heng_end, start_length)
  const start_p1_p2_vector = FP.turnAngleFromEnd(in_heng_end, start_p1, topAngle, 100)
  const start_p4_p3_vector = FP.turnAngleFromEnd(out_heng_end, start_p4, bottomAngle, 100)
  const start_p2_p3_vector = FP.turnAngleFromStart(heng_start, out_heng_start, leftAngle, 100)
