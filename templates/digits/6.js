...
const getComponents = (skeleton, global_params) => {
  ...
  const start_serif_angle = Math.atan2(out_stroke1_curves[0].start.y - in_stroke1_curves[0].start.y, (out_stroke1_curves[0].start.x - in_stroke1_curves[0].start.x))
  const start_serif_curves = FP.getCircle(start_serif_o, start_serif_size / 2, -start_serif_angle, true)
  const {
  ...
  //   x: out_stroke1_curves_final_2[0].start.x,
  //   y: out_stroke1_curves_final_2[0].start.y,
  // })
  // const joint_4 = new FP.Joint('joint_4', {
  //   x: out_stroke1_curves_final_2[0].control1.x,
  //   y: out_stroke1_curves_final_2[0].control1.y,
  // })
