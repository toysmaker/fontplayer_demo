...
const getComponents = (skeleton, global_params) => {
  ...
  //   x: end_serif_curves_final[end_serif_curves_final.length - 1].control2.x,
  //   y: end_serif_curves_final[end_serif_curves_final.length - 1].control2.y,
  // })
  // const joint_2 = new FP.Joint('joint_2', {
  //   x: end_serif_curves_final[end_serif_curves_final.length - 1].end.x,
  //   y: end_serif_curves_final[end_serif_curves_final.length - 1].end.y,
  // })
  // const joint_3 = new FP.Joint('joint_3', {
  //   x: in_stroke2_curves_final_2[0].start.x,
  //   y: in_stroke2_curves_final_2[0].start.y,
  // })
  // const joint_4 = new FP.Joint('joint_4', {
  //   x: in_stroke2_curves_final_2[0].control1.x,
  //   y: in_stroke2_curves_final_2[0].control1.y,
  // })
  ...
  //   const joint = new FP.Joint(`joint_${i + 1}`, {
  //     x: in_stroke2_points[i].x,
  //     y: in_stroke2_points[i].y,
  //   })
