...
const getComponents = (skeleton) => {
  ...
  const out_turn_p5_radius_before = FP.getPointOnLine(out_turn_p5, out_turn_p4, FP.distance(out_turn_p5, out_turn_p4) * 0.5)
  const out_turn_p5_radius_after = FP.getPointOnLine(out_turn_p5, out_turn_p6, FP.distance(out_turn_p5, out_turn_p6) * 0.5)
  const out_turn_p6_radius_before = FP.getPointOnLine(out_turn_p6, out_turn_p5, FP.distance(out_turn_p6, out_turn_p5) * 0.5)
  const out_turn_p6_radius_after = FP.getPointOnLine(out_turn_p6, out_turn_p7, FP.distance(out_turn_p6, out_turn_p7) * 0.5)
  ...
  const end_p6 = zhe_end
  const end_p5 = FP.turnAngleFromEnd(zhe_start, zhe_end, -(FP.degreeToRadius(90) - endRightAngle), _weight * 0.5)
  const end_p7 = FP.turnAngleFromEnd(zhe_start, zhe_end, FP.degreeToRadius(90) + endRightAngle, _weight * 0.6)
  ...
  const end_p10 = FP.getPointOnLine(end_p9, in_turn_p6, FP.distance(end_p9, in_turn_p6) * 0.5)
