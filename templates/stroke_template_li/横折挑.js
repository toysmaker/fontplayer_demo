...
const getComponents = (skeleton) => {
  ...
  const control_length_2 = Math.min(l_2 * 0.5 * 0.8, 45)

  const out_turn_p2 = FP.turnLeft(in_heng_end, FP.getPointOnLine(in_heng_end, in_heng_start, l * 0.5 - control_length), d)
  const out_turn_p1 = FP.turnLeft(in_heng_end, FP.getPointOnLine(in_heng_end, in_heng_start, l * 0.5), d)
  const out_turn_p0 = FP.turnLeft(in_heng_end, FP.getPointOnLine(in_heng_end, in_heng_start, l * 0.5 + control_length), d)
  const in_turn_p2 = FP.turnRight(out_heng_end, FP.getPointOnLine(out_heng_end, out_heng_start, l * 0.5 - control_length), d)
  const in_turn_p1 = FP.turnRight(out_heng_end, FP.getPointOnLine(out_heng_end, out_heng_start, l * 0.5), d)
  const in_turn_p0 = FP.turnRight(out_heng_end, FP.getPointOnLine(out_heng_end, out_heng_start, l * 0.5 + control_length), d)
  ...
  const out_turn_p9 = FP.turnLeft(in_zhe_end, FP.getPointOnLine(in_zhe_end, in_zhe_start, l_2 * 0.5 - control_length_2), d)
  const out_turn_p8 = FP.turnLeft(in_zhe_end, FP.getPointOnLine(in_zhe_end, in_zhe_start, l_2 * 0.5), d)
  const out_turn_p7 = FP.turnLeft(in_zhe_end, FP.getPointOnLine(in_zhe_end, in_zhe_start, l_2 * 0.5 + control_length_2), d)
  const in_turn_p6 = FP.turnRight(out_zhe_end, FP.getPointOnLine(out_zhe_end, out_zhe_start, l_2 * 0.5 - control_length_2), d)
  const in_turn_p5 = FP.turnRight(out_zhe_end, FP.getPointOnLine(out_zhe_end, out_zhe_start, l_2 * 0.5), d)
  const in_turn_p4 = FP.turnRight(out_zhe_end, FP.getPointOnLine(out_zhe_end, out_zhe_start, l_2 * 0.5 + control_length_2), d)
  const in_turn_p3 = out_corner_heng_zhe
  ...
  const end_p1 = out_corner_zhe_tiao_2
  const end_p2 = out_corner_zhe_tiao_1
  const end_p3 = out_corner_zhe_tiao
  const end_p4 = tiao_end
  const end_p5 = in_corner_zhe_tiao
  const end_p0 = FP.getPointOnLine(end_p1, in_turn_p6, FP.distance(end_p1, in_turn_p6) * 0.5)

  const end_p2_radius_before = FP.getPointOnLine(end_p2, end_p1, FP.distance(end_p2, end_p1) * 0.7)
  ...
  const end_p3_radius_after = FP.getPointOnLine(end_p3, end_p4, radius * 2)
  const end_p4_radius_before = FP.getPointOnLine(end_p4, end_p3, Math.min(FP.distance(end_p4, end_p3) * 0.5, radius))
  const end_p4_radius_after = FP.getPointOnLine(end_p4, end_p5, Math.min(FP.distance(end_p4, end_p5) * 0.5, radius))
